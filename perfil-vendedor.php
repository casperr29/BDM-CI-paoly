<?php 
    ...
    if($sql->fetchColumn()>0){
        ...
        $sql=$con->prepare('SELECT libro.LibroID, media.imagen1 FROM Libro INNER JOIN media ON libro.LibroID=media.LibroID WHERE Usuario_libro=:usuario');
        $sql->execute(['usuario' => $usuario->getID()]);
...
<body>
    ...
    <div class="cols__container">
        <div class="left__col">
            ...
            <a href="ventas.php" class="btn">Consultar Ventas </a>
